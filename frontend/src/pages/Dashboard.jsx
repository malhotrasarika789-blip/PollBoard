...
icon={<Clock/>}
title="Active Polls"
value={polls.filter((p)=>!p.published).length}
/>
...
key={poll._id}
id={poll._id}
title={poll.title||poll.question||poll.questions?.[0]?.question||"Untitled Poll"}
responses={poll.options?.length||poll.questions?.length||0}
